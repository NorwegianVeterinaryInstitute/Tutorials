...
results <- foreach(i = 1:100, .combine = c) %dopar% {
  ...
  saveRDS(result, file = paste0("/home/vetinst.no/vi2313/R-tutorials/data/part_r_rstudio_tutorials/parallelization_on_workbench/for_each/result_", i, ".rds"))
  result
}
...
safe_compute <- function(i) {
  result <- i^2
  saveRDS(result, file = paste0("/home/vetinst.no/vi2313/R-tutorials/data/part_r_rstudio_tutorials/parallelization_on_workbench/future_apply/partial_result_", i, ".rds"))
  return(result)
}
...
saveRDS(final_results, file = "/home/vetinst.no/vi2313/R-tutorials/data/part_r_rstudio_tutorials/parallelization_on_workbench/future_apply/final_results.rds")
...
checkpoint_dir <- "/home/vetinst.no/vi2313/R-tutorials/data/part_r_rstudio_tutorials/parallelization_on_workbench/checkpoints_parallel/"
