...
The process is described in the official documentation at: [Git-Backed Content](https://docs.posit.co/connect/user/git-backed/). Please refer to that link for details.
